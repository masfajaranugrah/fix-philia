...
const Card = () => {
  return (
    <div className="relative">
      <div>
        <h1 className="text-[23px]   md:text-[34px]  text-[#2D210A] lg:text-[40px] font-[1000] text-center">
        FASILITAS
        </h1>
      </div>
            ...
            >
              <div className="flex flex-col px-2 md:px-2 xl:px-2 lg:px-2 items-center justify-center">
                <div className="flex flex-col md:flex-row xl:flex-row lg:flex-row">
                  <div className="xl:w-[100%] w-full md:w-[100%] pt-10 flex justify-center">
                    <img
                      src={item.image}
                      alt={item.title}
                  ...
                  <div className="p-6 xl:w-[200%] md:w-[200%] flex md:justify-start md:items-start flex-col">
                    <h4 className="mb-2 text-[20px] md:text-[24px] lg:text-[20px] xl:text-[30px] text-center font-bold text-blue-gray-900">
                      {item.title}
                    </h4>
                    <p className="text-[16px] md:text-[18px] xl:text-[17px] text-center xl:text-start lg:text-start md:text-start text-gray-700">
                      {item.description}
                    </p>
                  </div>
                </div>
